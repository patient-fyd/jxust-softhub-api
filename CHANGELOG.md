...
- gf 版本升级到 `v2.5.1`
- 当前项目 package 名称由 `jxust-softhub-api` 改为 `github.com/windvalley/jxust-softhub-api`
...
- `Makefile`
  - 优化`make cli.install`, 解决因官方 gf cli 升级可能导致的本项目编译报错问题: [#2](https://github.com/windvalley/jxust-softhub-api/issues/2), [#3](https://github.com/windvalley/jxust-softhub-api/issues/3)
...
- 优化 systemctl 部署服务方式
  - 优化服务文件 `manifest/deploy/systemctl/jxust-softhub-api-api*.service`
