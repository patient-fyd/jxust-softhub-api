...
// RolePermissionsColumns defines and stores column names for table role_permissions.
type RolePermissionsColumns struct {
	RoleId       string // 角色ID，关联 roles 表
	PermissionId string // 权限ID，关联 permissions 表
}

// rolePermissionsColumns holds the columns for table role_permissions.
